...
fn update_op_button_background<W: Widget>(
    ...
    match state.state() {
        Button::STATE_HOVERED => widget.set_background_color(BinaryColor::Off),
        Button::STATE_PRESSED => widget.set_background_color(BinaryColor::On),
        _ => widget.set_background_color(BinaryColor::On),
    };
}
...
{
    match state.state() {
        Button::STATE_HOVERED => widget.set_text_color(BinaryColor::On),
        Button::STATE_PRESSED => widget.set_text_color(BinaryColor::Off),
        _ => widget.set_text_color(BinaryColor::Off),
    };
}
